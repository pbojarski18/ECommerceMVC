...
namespace ECommerceMVC.Persistence.Migrations
{
    ...
    [Migration("20250205165833_ExtendedIdentityUserAddressesTableFixedAndModifiedOrders")]
    partial class ExtendedIdentityUserAddressesTableFixedAndModifiedOrders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceMVC.Domain.Entities.AddressEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceMVC.Domain.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ECommerceMVC.Domain.Entities.AddressEntity", b =>
                {
                    b.HasOne("ECommerceMVC.Domain.Entities.ApplicationUser", "User")
                        .WithMany("Addresses")
            ...
            modelBuilder.Entity("ECommerceMVC.Domain.Entities.OrderEntity", b =>
                {
                    b.HasOne("ECommerceMVC.Domain.Entities.AddressEntity", "Address")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ECommerceMVC.Domain.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
